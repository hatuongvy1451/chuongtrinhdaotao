...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 14, 2025 lúc 04:42 PM
...
CREATE TABLE `ctdt_decuongchitiet` (
  ...
  `phuong_phap_giang_day` text NOT NULL,
  `phuong_phap_danh_gia` text NOT NULL,
  `tai_lieu_tham_khao` text DEFAULT NULL,
  `trang_thai` int(11) NOT NULL DEFAULT 1 COMMENT '0: Chờ duyệt, 1: Đã duyệt'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ctdt_decuongchitiet` (`id`, `id_hocphan`, `mo_ta`, `muc_tieu`, `chuong_noi_dung`, `phuong_phap_giang_day`, 
`phuong_phap_danh_gia`, `tai_lieu_tham_khao`, `trang_thai`) 
VALUES
(1, 1, 
 ...
 'Bài giảng lý thuyết, thảo luận nhóm',
...
(3, 3,
 ...
 'Trình bày thuyết trình, nghiên cứu tình huống',
...
(4, 4,
 ...
 'Thực hành quân sự và học lý thuyết',
...
CREATE TABLE `ctdt_giangvien` (
  ...
  `trang_thai` int(11) NOT NULL DEFAULT 1 COMMENT '0: Ngưng làm việc, 1: Đang làm việc'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `ctdt_kehoachmonhom` (
  ...
  `trang_thai` int(11) NOT NULL DEFAULT 0 COMMENT '0: Đã kết thúc, 1: Đang mở'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ctdt_kehoachmonhom` (`id`, `id_hocphan`, `nam_hoc`, `so_nhom`, `trang_thai`) VALUES
(1, 1, '2025-2026', 4, 0),
(2, 2, '2025-2026', 3, 0),
(3, 3, '2025-2026', 3, 0),
(4, 4, '2025-2026', 2, 0),
...
CREATE TABLE `ctdt_thongtinchung` (
  ...
  `trang_thai` int(11) NOT NULL DEFAULT 1 COMMENT '0: Ngưng áp dụng, 1: Đang áp dụng'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'CNTT', 'Chương trình đào tạo ngành Công nghệ thông tin', 'Đại học, Bậc 7/8 đối với đào tạo kỹ sư', 'Kỹ sư', 'Chính quy', 4.5, 155, 'Công nghệ thông tin', 'Tiếng Việt', 'http://fit.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn', 1),
(2, 'KT', 'Chương trình đào tạo ngành Kế toán', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 135, 'Khoa Kế toán', 'Tiếng Việt', 'http://accounting.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn', 1),
(3, 'QTKD', 'Chương trình đào tạo ngành Quản trị Kinh doanh', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 140, 'Khoa Quản trị Kinh doanh', 'Tiếng Việt', 'http://business.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn', 1),
...
(5, 'NN', 'Chương trình đào tạo ngành Ngôn ngữ Anh', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 130, 'Khoa Ngôn ngữ Anh', 'Tiếng Anh', 'http://english.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn', 1);
