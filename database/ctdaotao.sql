...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 08, 2025 lúc 03:44 PM
...
INSERT INTO `ctdt_decuongchitiet` (`id`, `id_hocphan`, `mo_ta`, `muc_tieu`, `chuong_noi_dung`, `bo_phan_danh_gia`, `ten_diem_danh_gia`, `trong_so_danh_gia`, `hinh_thuc_danh_gia`, `tai_lieu_tham_khao`) VALUES
(1, 1, 'Học phần này cung cấp nguyên tắc cơ bản và cách tiếp cận của triết học Mác-Lênin.', 'Giúp sinh viên hiểu và vận dụng các nguyên lý triết học vào phân tích thực tế.', 'Chương 1: Khái niệm triết học\nChương 2: Phép biện chứng duy vật\nChương 3: Lịch sử triết học Mác', 'Kiểm tra giữa kỳ và bài luận cuối kỳ', 'Kiểm tra giữa kỳ', 30, 'Trắc nghiệm và tự luận', 'Triết học Mác-Lênin, NXB Giáo dục, 2021'),
(2, 2, 'Nội dung cung cấp kiến thức về quy luật kinh tế và cơ sở lý luận kinh tế chính trị.', 'Hiểu được mối quan hệ giữa sản xuất, phân phối, và tiêu dùng trong nền kinh tế.', 'Chương 1: Quy luật giá trị\nChương 2: Lý thuyết lao động giá trị\nChương 3: Kinh tế vĩ mô theo Mác', 'Bài tập nhóm và bài kiểm tra cuối kỳ', 'Bài kiểm tra cuối kỳ', 40, 'Tự luận và thuyết trình', 'Kinh tế chính trị, NXB Chính trị Quốc gia, 2020'),
(3, 3, 'Học phần nghiên cứu về sự hình thành và phát triển của chủ nghĩa xã hội khoa học.', 'Tăng cường khả năng phân tích các quan điểm lý luận về chủ nghĩa xã hội.', 'Chương 1: Tư tưởng Mác về chủ nghĩa xã hội\nChương 2: Lịch sử phát triển CNXH\nChương 3: Ứng dụng CNXH vào thực tiễn', 'Thuyết trình và bài kiểm tra cuối kỳ', 'Thuyết trình', 50, 'Bài tập nhóm', 'Chủ nghĩa xã hội khoa học, NXB Giáo dục, 2021'),
(4, 4, 'Giới thiệu các kiến thức cơ bản về quốc phòng và an ninh.', 'Trang bị kỹ năng cơ bản và nâng cao ý thức trách nhiệm đối với quốc phòng.', 'Chương 1: Kiến thức quốc phòng cơ bản\nChương 2: Quân sự căn bản\nChương 3: Quản lý quốc phòng', 'Thực hành quân sự và bài kiểm tra cuối kỳ', 'Thực hành quân sự', 40, 'Thực hành và tự luận', 'Tài liệu quốc phòng, NXB Quốc phòng, 2019'),
(5, 5, 'Học phần giúp sinh viên nâng cao kỹ năng nghe, nói, đọc, viết tiếng Anh ở mức cơ bản.', 'Rèn luyện nền tảng ngoại ngữ phục vụ học tập và giao tiếp.', 'Chương 1: Phát âm cơ bản\nChương 2: Ngữ pháp cơ bản\nChương 3: Viết luận cơ bản', 'Bài tập nhóm và kiểm tra cuối kỳ', 'Bài kiểm tra cuối kỳ', 30, 'Trắc nghiệm và bài tập nhóm', 'Tiếng Anh cơ bản, NXB Đại học Quốc gia, 2020'),
(6, 6, 'Giới thiệu nền tảng lập trình bằng các ngôn ngữ lập trình cơ bản.', 'Cung cấp kỹ năng tư duy logic và áp dụng giải thuật lập trình.', 'Chương 1: Biến và kiểu dữ liệu\nChương 2: Vòng lặp và điều kiện\nChương 3: Xây dựng hàm', 'Bài tập cá nhân và bài kiểm tra thực hành', 'Bài kiểm tra thực hành', 40, 'Thực hành và tự luận', 'Lập trình cơ bản bằng C, NXB Khoa học, 2019'),
(7, 7, 'Học phần cung cấp kiến thức cơ bản về thiết kế và tối ưu hóa cơ sở dữ liệu.', 'Hiểu và áp dụng các mô hình dữ liệu trong thực tế.', 'Chương 1: Tổng quan cơ sở dữ liệu\nChương 2: SQL cơ bản\nChương 3: Quản trị cơ sở dữ liệu', 'Thực hành và đồ án cuối kỳ', 'Đồ án cuối kỳ', 60, 'Thực hành và báo cáo', 'Cơ sở dữ liệu, NXB Khoa học Kỹ thuật, 2020'),
(8, 8, 'Giới thiệu các phương pháp và công cụ kiểm thử phần mềm.', 'Tăng cường kỹ năng kiểm thử, đảm bảo chất lượng sản phẩm.', 'Chương 1: Kiểm thử chức năng\nChương 2: Kiểm thử hiệu năng\nChương 3: Công cụ kiểm thử', 'Bài tập thực hành và bài kiểm tra giữa kỳ', 'Kiểm tra giữa kỳ', 50, 'Thực hành và tự luận', 'Kiểm thử phần mềm, NXB Công nghệ, 2018'),
(9, 9, 'Khóa học tập trung vào thiết kế và phát triển phần mềm theo mô hình phân lớp.', 'Nâng cao kỹ năng lập trình phần mềm hiện đại.', 'Chương 1: Phân tích yêu cầu\nChương 2: Thiết kế lớp xử lý\nChương 3: Triển khai và kiểm thử', 'Đồ án nhóm và bài kiểm tra cuối kỳ', 'Đồ án cuối kỳ', 50, 'Thực hành và báo cáo', 'Thiết kế phần mềm phân lớp, NXB Khoa học, 2019'),
(10, 10, 'Nội dung yêu cầu sinh viên thực hiện một dự án thực tế.', 'Hoàn thiện kỹ năng thiết kế, lập trình và phân tích dự án.', 'Chương 1: Lập kế hoạch dự án\nChương 2: Thực thi dự án\nChương 3: Báo cáo và đánh giá', 'Báo cáo đồ án và thuyết trình', 'Báo cáo đồ án', 100, 'Thuyết trình và phản biện', 'Tài liệu tham khảo tùy theo đề tài.');
...
INSERT INTO `ctdt_giangvien` (`id`, `id_taikhoan`, `ma_giang_vien`, `ten_giang_vien`, `email_giang_vien`, `chuyen_mon`, `loai_giang_vien`) VALUES
(1, 6, 'GV001', 'Lê Minh D', '', 'Lập trình phần mềm nâng cao', 1),
(2, 7, 'GV002', 'Hoàng Ngọc E', '', 'Hệ thống thông tin', 1),
(3, 8, 'GV003', 'Nguyễn Văn F', '', 'Mạng máy tính và bảo mật', 1),
(4, 9, 'GV004', 'Dương Văn J', '', 'Phát triển ứng dụng web', 1),
(5, 10, 'GV005', 'Nguyễn Văn A', '', 'Trí tuệ nhân tạo và Học máy', 1),
(6, 11, 'GV006', 'Phạm Thị L', '', 'Hệ thống nhúng', 1),
(7, 12, 'GV007', 'Ngô Văn H', '', 'Bảo mật và an toàn thông tin', 0),
(8, 13, 'GV008', 'Lê Thị Thúy H', '', 'Blockchain và Công nghệ số', 0),
(9, 14, 'GV009', 'Trần Đức M', '', 'Phân tích dữ liệu lớn (Big Data)', 0),
(10, 15, 'GV010', 'Hoàng Gia N', '', 'Lập trình di động', 0);
...
INSERT INTO `ctdt_hocphan` (`id`, `id_khungct`, `ma_hoc_phan`, `ten_hoc_phan`, `so_tin_chi`, `so_tiet_ly_thuyet`, `so_tiet_thuc_hanh`, `so_tiet_thuc_tap`, `so_tiet_cong`, `he_so_hocphan`) VALUES
...
INSERT INTO `ctdt_kehoachdayhoc` (`id`, `id_hocphan`, `hoc_ky_thuc_hien`, `ma_hocphan_truoc`) VALUES
(1, 1, 1, NULL),
(2, 2, 1, NULL),
(3, 3, 2, 'DC001'),
(4, 4, 1, NULL),
...
INSERT INTO `ctdt_kehoachmonhom` (`id`, `id_hocphan`, `nam_hoc`, `so_nhom`) VALUES
(1, 1, '2025-2026', 4),
(2, 2, '2025-2026', 3),
(3, 3, '2025-2026', 3),
(4, 4, '2025-2026', 2),
...
INSERT INTO `ctdt_khungchuongtrinh` (`id`, `id_thongtin`, `ten_khoi`, `loai_khoi`, `tin_chi_bat_buoc`, `tin_chi_tu_chon`) VALUES
...
INSERT INTO `ctdt_phanconggiangday` (`id`, `id_giangvien`, `id_hocphan`, `hoc_ky`, `so_tiet_thuc_hien`, `so_tiet_thuc_te`) VALUES
(1, 1, 1, 1, 30, 30),
(2, 2, 2, 1, 20, 20),
(3, 3, 3, 2, 20, 20),
(4, 4, 4, 1, 20, 20),
...
INSERT INTO `ctdt_thongtinchung` (`id`, `ma_ctdt`, `ten_ctdt`, `bac_dao_tao`, `loai_bang`, `loai_hinh_dao_tao`, `thoi_gian_dao_tao`, `tin_chi_toi_thieu`, `khoa_quan_ly`, `ngon_ngu`, `website`, `ban_hanh`) VALUES
...
(2, 'KT', 'Chương trình đào tạo ngành Kế toán', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 135, 'Khoa Kế toán', 'Tiếng Việt', 'http://accounting.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn'),
(3, 'QTKD', 'Chương trình đào tạo ngành Quản trị Kinh doanh', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 140, 'Khoa Quản trị Kinh doanh', 'Tiếng Việt', 'http://business.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn'),
(4, 'SP', 'Chương trình đào tạo ngành Sư phạm Toán học', 'Đại học', 'Cử nhân Sư phạm', 'Chính quy', 4.5, 150, 'Khoa Sư phạm', 'Tiếng Việt', 'http://education.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn'),
(5, 'NN', 'Chương trình đào tạo ngành Ngôn ngữ Anh', 'Đại học', 'Cử nhân', 'Chính quy', 4.0, 130, 'Khoa Ngôn ngữ Anh', 'Tiếng Anh', 'http://english.sgu.edu.vn/', 'Theo Quyết định số ........./QĐ-ĐHSG ngày .... tháng .... năm 2020 của Hiệu trưởng Trường Đại học Sài Gòn');
...
CREATE TABLE `ctdt_user` (
  ...
  `vai_tro` int(11) NOT NULL COMMENT '0: User, 1: Giảng viên, 2: Admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ctdt_user` (`id`, `ten_dang_nhap`, `mat_khau`, `ho_ten`, `email`, `vai_tro`) VALUES
